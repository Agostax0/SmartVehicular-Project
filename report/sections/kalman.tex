...
\begin{tikzpicture}[node distance=1.6cm, auto,
    block/.style={rectangle, draw, align=center, rounded corners, minimum height=2em, minimum width=7em},
    input/.style={rectangle, draw=gray, dashed, align=center, minimum height=2em, minimum width=7em},
