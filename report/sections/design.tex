...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[node distance=2cm, >=latex]
      \tikzset{
        ...
        submodule/.style={draw, fill=yellow!10, rounded corners, minimum height=1.2cm, minimum width=2.5cm, align=center},
        flow/.style={->, thick},
      ...
      \node[module, left=2cm of core] (controllers) {Controllers};
      \node[module, right=2cm of core] (sensors) {Sensors};
      
      \node[submodule, fill=green!10, below=2cm of core] (utils) {Utils};
      \node[submodule, fill=orange!10, below=2cm of utils] (scenarios) {Scenarios};
    
      % Connections
      \draw[flow] (core) -- (utils);
      \draw[flow] (controllers) |- (utils);
      \draw[flow] (sensors) |- (utils);
    
      \draw[dep] (scenarios) -- (utils);
      \draw[dep] (scenarios.west) -| (controllers.south);
      \draw[dep] (scenarios.east) -| (core.south);
