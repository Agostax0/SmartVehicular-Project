...
\begin{enumerate}
    ...
    \item \textbf{Autonomous Control}: Created a velocity-based control system that can brake automatically when collision is imminent, along with an optional manual keyboard override for testing.
