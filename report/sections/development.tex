...
\begin{itemize}
    ...
    \begin{itemize}
        \item \verb|vehicle_controller.py|: Velocity-based control
    \end{itemize}
    
    \item \texttt{src/sensors/}: Sensor management
    \begin{itemize}
        \item \verb|sensor_manager.py|: Sensor lifecycle management
    \end{itemize}
    
    \item \texttt{src/utils/}: Utility modules
    \begin{itemize}
        \item \verb|collision_module.py|: Collision risk assessment
        ...
        \item \verb|carla_utils.py|: CARLA integration utilities
    ...
    \item \verb|src/run_simulation.py|: CLI entry point
\end{itemize}
...
\begin{enumerate}
    ...
    \item Create a feature branch (\verb|feature/<your-feature>|)
